		...
		?>
			<tr>
				...
				<td>
					...
					<a href="piutang-hapus.php?id=<?= $x->id ?>" class="btn btn-sm btn-danger">
						Hapus
					</a>
				</td>
			</tr>
...
<div class="modal fade" id="modalTambah">
	<div class="modal-dialog">
		<form class="modal-content" method="POST" action="piutang-tambah.php">
...
<div class="modal fade" id="modalUbah">
	<div class="modal-dialog">
		<form class="modal-content" method="POST" action="piutang-ubah.php">
			<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label>Kepada</label>
					<input type="text" name="kepada" class="form-control" id="kepada" required>
				</div>
				<div class="form-group">
					<label>Jumlah</label>
