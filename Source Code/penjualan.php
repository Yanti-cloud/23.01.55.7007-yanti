<?php
	...
	curl_close($curl4);
	$pelanggan = json_decode($response4);
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td class="text-right"><?= $data3->harga ?></td>
				...
				<td>
					...
					<a href="penjualan-hapus.php?id=<?= $x->id ?>" class="btn btn-sm btn-danger">
						Hapus
					</a>
				</td>
			</tr>
...
<div class="modal fade" id="modalTambah">
	<div class="modal-dialog">
		<form class="modal-content" method="POST" action="penjualan-tambah.php">
...
<div class="modal fade" id="modalUbah">
	<div class="modal-dialog">
		<form class="modal-content" method="POST" action="penjualan-ubah.php">
			<div class="modal-header">
