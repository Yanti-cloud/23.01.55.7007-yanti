<?php
	...
	curl_setopt_array($curl, array(
		CURLOPT_URL => 'https://andriyanti.site/yanti/api.php/records/gaji',
	...
	curl_setopt_array($curl3, array(
		CURLOPT_URL => 'https://andriyanti.site/yanti/api.php/records/karyawan',
		CURLOPT_RETURNTRANSFER => true,
		CURLOPT_ENCODING => '',
		CURLOPT_MAXREDIRS => 10,
		CURLOPT_TIMEOUT => 0,
				...
				<td>
					<?php
						...
						curl_setopt_array($curl2, array(
							CURLOPT_URL => 'https://andriyanti.site/yanti/api.php/records/karyawan/'.$x->id_karyawan,
							CURLOPT_RETURNTRANSFER => true,
							CURLOPT_ENCODING => '',
							CURLOPT_MAXREDIRS => 10,
							CURLOPT_TIMEOUT => 0,
